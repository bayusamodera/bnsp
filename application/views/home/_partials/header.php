...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/template/adminlte3/') ?>dist/css/stylehome.css">
    ...
    <link rel="icon" type="image/png" href="<?= base_url('assets/images/')?>favicon/logo.jpg">
